...
class RequestGuidelines extends StatefulWidget {
  ...
  @override
  _RequestGuidelinesState createState() => _RequestGuidelinesState();
}

class _RequestGuidelinesState extends State<RequestGuidelines> {
  @override
...
Widget _agreementDescription() {
  const title = "Guidelines For Requesting Donations";
  const description =
...
List<Item> agreementItems = [
  Item(
    headerValue:
        'I acknowledge that I am requesting foods that are in the following:',
    expandedValue:
  ...
  Item(
    headerValue:
        'I acknowledge that I am not requesting foods that are in the following:',
    expandedValue:
