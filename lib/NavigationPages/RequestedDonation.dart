...
class RequestedDonation extends StatefulWidget {
  static String routeName = "/RequestedDonation";
  @override
  _RequestedDonation createState() => _RequestedDonation();
}

class _RequestedDonation extends State<RequestedDonation> {
        ...
        child: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: const <Widget>[
              ...
              Tab(
                child: Text(
                  "My Unfulfilled Request",
                  style: TextStyle(color: Colors.black, fontSize: 12),
                ),
              ),
              Tab(
                child: Text(
                  "Other's Request Ongoing",
                  style: TextStyle(color: Colors.black, fontSize: 12),
                ),
              ),
              Tab(
                child: Text(
                  "Other's Request Fulfilled",
                  style: TextStyle(color: Colors.black, fontSize: 12),
                ),
              ),
            ],
